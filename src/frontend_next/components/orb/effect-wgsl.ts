// 由 orb repo 的 effect.wgsl 內嵌而來（MIT, https://github.com/LerSent001/orb）
// Turbopack 不支援 ?raw import，故以字串模組載入
const effectSource = `// Glass Liquid — curated flow programs with an optional glass shell.
//
